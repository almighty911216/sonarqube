...
public class IssueTagsTest {
  ...
  public void getTags() throws Exception {
    ...
    {
      assertTags(null, null, organizationKey, publicTags);
      assertTags(null, null, null, publicTags);
    }
    ...
    // stranger must not see custom tags of private project
    {
      ...
      assertTags(stranger, strangerPassword, null, publicTags);
    }
    ...
    // member with user permission must be able to see custom tags of private project, if he provides the organization parameter
    {
      ...
      assertTags(member, memberPassword, null, publicTags);
    }
  }

  private void makeMember(String member) {
  ...
  private void assertTags(String user, String password, @Nullable String organization, String... expectedTags) {
    assertThat(
