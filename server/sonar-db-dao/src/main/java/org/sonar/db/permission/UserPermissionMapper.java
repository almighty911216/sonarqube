...
public interface UserPermissionMapper {
  ...
  List<Integer> selectUserIdsByQuery(@Param("query") PermissionQuery query, @Param("pagination") Pagination pagination);

  /**
   * Count the number of distinct users returned by {@link #selectUserIdsByQuery(PermissionQuery, Pagination)}
